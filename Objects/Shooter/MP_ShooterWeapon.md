...
>   This is called by the RPC when the networked versions receive a request from the owner for them to play a shot. 
...
>   If owner will send an RPC to all networked versions to play the empty clip sound. 
...
>   This is called via the OnShot UnityEvent and will cause the networked versions to fire a shot with this weapon. 
